...
export const electronAPI = {
  ...
  gitStage: (paths: string[]) => rpc.request.gitStage({ paths }),
  gitUnstage: (paths: string[]) => rpc.request.gitUnstage({ paths }),
  gitCommit: (message: string) => rpc.request.gitCommit({ message }),
